...
export default function EditAssignmentPage() {
    ...
    const { data: assignment, isLoading: assignmentLoading } =
        useGetTestAssignmentByIdQuery(id, { skip: !id });
    ...
    const [updateAssignment, { isLoading: isSaving }] = useUpdateTestAssignmentMutation();
        ...
        <div className="p-6">
            <AssignmentForm
                ...
                onSubmit={async (payload) => {
                    const updated = await updateAssignment({ id, data: payload }).unwrap();
